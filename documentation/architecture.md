...
| `/:locale/galerija` | `src/pages/[locale]/galerija.astro` | Gallery — 135 island photos served as alternating infinite-scroll `MiniCollage` strips (13–14 strips of 10 photos each); strips alternate direction (`reverse` prop); photos shuffled deterministically by locale seed; poetic Croatian captions assigned by rotation; `HeroSimple` with intro text; linked from main nav |
