...
- **Status:** Implemented — 139 real island photos in alternating scrolling collage strips (14 strips); locale-specific intro text in all 4 locales; locale-seeded deterministic shuffle for per-language visual variety; 50 poetic Croatian captions used as alt text (not rendered visually); fixed 80s scroll speed per strip; zero stock photos
