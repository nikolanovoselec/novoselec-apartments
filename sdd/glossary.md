...
| **Poetic Captions** | 50 evocative Croatian-language short phrases assigned to gallery photos by rotating index. Used as alt text only (not rendered as visible text). Not localized -- Croatian only, reflecting the love-letter editorial voice. |
