...
| **Poetic Captions** | 50 evocative Croatian-language short phrases assigned to gallery photos by rotating index. Rendered as visible overlay captions on photos (italic white text over a bottom-edge gradient) via the `showCaptions` prop, and also used as alt text. Not localized -- Croatian only, reflecting the love-letter editorial voice. |
