...
| **Sailboat Logo** | The brand icon for Apartmani Novoselec — a sailboat silhouette PNG (`/logo.png`) with transparent background. Displayed in the header (28px), footer (36px), mobile menu (48px), and used as the source for all favicon PNGs. Rendered white on dark backgrounds via CSS `brightness(0) invert(1)` filter; original colors on light backgrounds. |
